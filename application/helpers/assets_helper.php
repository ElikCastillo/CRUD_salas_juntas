...
function get_css_files()
{
	...
	$css_files = array(
		...
		array('path' => 'assets/css/full-calendar/main.min.css'),
	);
	if (!defined("ASSET_MODE") or ASSET_MODE == 'development') {
		$return = $css_files;
	} else {
		$return[] = array('path' => "assets/css/all.css");
		$return[] = array('path' => 'assets/css/quill.core.css');
		$return[] = array('path' => 'assets/css/quill.snow.css');
		$CI = &get_instance();
		if ($CI->uri->segment(1) == "reservations" && $CI->uri->segment(2) == "dashboard") $return[] = array('path' => 'assets/css/full-calendar/main.min.css');
	}
...
function get_js_files()
{
	...
	return array(
		...
		array('path' => 'assets/js/quill.core.js'),
		array('path' => 'assets/js/quill.js'),
		array('path' => 'assets/js/quill.min.js'),
		array('path' => 'assets/js/full-calendar/main.min.js'),
		array('path' => 'assets/js/full-calendar/locales-all.js'),
		array('path' => 'assets/js/jquery.countTo.js'),
		array('path' => 'assets/js/bootstrap-nav-paginator.min.js'),
	);
}
